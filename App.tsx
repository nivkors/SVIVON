...
const CreditsFooter = () => (
    <div className="flex items-center justify-center gap-2 py-1 text-[10px] text-slate-500/70 hover:text-slate-400 transition-colors pointer-events-auto">
        <span>נבנה ע"י niv</span>
        <span className="opacity-30">|</span>
        <a 
            href="https://wa.me/972508430796" 
            target="_blank" 
